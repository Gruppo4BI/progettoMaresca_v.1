...
<div class="container-fluid">
  ...
  <fieldset class="form-group">
   ...
   <fieldset class="form-group">
    ...
    <input type="text" pattern="[0-9]{1,15}"class="form-control" id="numero" name="numero" value='<?php echo $dati_tel["numero"]; ?>'>
  </fieldset>
  
    <fieldset class="form-group">
    <label for="numero2">Telefono 2 </label>
    <input type="text" pattern="[0-9]{1,15}" class="form-control" id="numero2" name="numero2" value='<?php echo $dati_tel["numero2"]; ?>'>
  </fieldset>
  
     <fieldset class="form-group">
    <label for="fax">Fax </label>
    <input type="text" pattern="[0-9]{1,15}" class="form-control" id="fax" name="fax" value='<?php echo $dati_tel["fax"]; ?>'>
  </fieldset>
  
       <fieldset class="form-group">
    <label for="cellulare">Cellulare</label>
    <input type="text" pattern="[0-9]{1,15}" class="form-control" id="cellulare" name="cellulare" value='<?php echo $dati_tel["cellulare"]; ?>'>
  </fieldset>
